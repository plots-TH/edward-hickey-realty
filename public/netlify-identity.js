  ...
  function (e, n, t) {
    ...
    function a(e, n) {
      ...
      for (
        n &&
        null != n.children &&
        (i.length || i.push(n.children), delete n.children);
        i.length;
      )
    ...
    function z(e, n) {
      return (
        e.normalizedNodeName === n ||
        e.nodeName.toLowerCase() === n.toLowerCase()
      );
    }
    function T(e) {
    ...
    function A(e, n, t, r, o) {
      if (("className" === n && (n = "class"), "key" === n));
        ...
        if ("style" === n) {
          if (
            ((r && "string" != typeof r && "string" != typeof t) ||
              (e.style.cssText = r || ""),
            r && "object" == typeof r)
          ) {
            if ("string" != typeof t)
          ...
          ((n = n.toLowerCase().substring(2)),
            r
              ? t || e.addEventListener(n, d, M)
              : e.removeEventListener(n, d, M),
    ...
    function x(e, n, t, r, o, i) {
      ...
      var M = L(e, n, t, r, i);
      return (
        o && M.parentNode !== o && o.appendChild(M),
        --E || ((I = !1), i || O()),
        M
      );
    }
    function L(e, n, t, r, o) {
        ...
        return (
          e && void 0 !== e.splitText && e.parentNode && (!e._component || o)
            ...
            : ((i = document.createTextNode(n)),
              e && (e.parentNode && e.parentNode.replaceChild(i, e), h(e, !0))),
          (i.__preactattr_ = !0),
          i
        );
      var a,
      ...
      if (null == l) {
        l = i.__preactattr_ = {};
        for (var D = i.attributes, g = D.length; g--; )
          l[D[g].name] = D[g].value;
      }
      return (
        !I &&
        N &&
          ...
          : ((N && N.length) || null != c) &&
            (function (e, n, t, r, o) {
              ...
              if (0 !== T)
                for (A = 0; A < T; A++) {
                  var E;
                  if (((u = n[A]), (s = null), null != (E = u.key)))
                    D && void 0 !== N[E] && ((s = N[E]), (N[E] = void 0), D--);
                  else if (g < z)
                    for (i = g; i < z; i++)
        ...
        (function (e, n, t) {
          ...
          for (r in t)
            (n && null != n[r]) ||
              null == t[r] ||
              A(e, r, t[r], (t[r] = void 0), w);
          for (r in n)
            "children" === r ||
              "innerHTML" === r ||
              (r in t &&
                n[r] === ("value" === r || "checked" === r ? e[r] : t[r])) ||
              A(e, r, t[r], (t[r] = n[r]), w);
        })(i, n.attributes, l),
        (w = M),
        i
    ...
    function b(e, n, t) {
      ...
      for (
        e.prototype && e.prototype.render
          ? ((r = new e(n, t)), Y.call(r, n, t))
          : (((r = new Y(n, t)).constructor = e), (r.render = k));
        o--;
      )
    ...
    function C(e, n, t, r, i) {
      e._disable ||
        ...
        (e._disable = !1),
        0 !== t &&
          (1 !== t && !1 === o.syncComponentUpdates && e.base
            ? g(e)
            : S(e, 1, i)),
        s(e.__ref, e));
    }
      ...
      if (!e._disable) {
        ...
        if (
          ...
          ((i = e.render(s, c, l)),
            ...
            y &&
              ...
              (d = e.getSnapshotBeforeUpdate(N, D)));
          var w,
            I,
            L = i && i.nodeName;
          if ("function" == typeof L) {
            ...
            ((a = z),
              ...
              (z || 1 === n) &&
                (a && (a._component = null),
                (I = x(a, i, l, t || !y, z && z.parentNode, !0))));
          if (z && I !== z && M !== f) {
            var m = z.parentNode;
            m &&
              I !== m &&
              (m.replaceChild(I, z), w || ((z._component = null), h(z, !1)));
          }
        ...
        for (
          !y || t
            ? p.push(e)
            : A ||
              (e.componentDidUpdate && e.componentDidUpdate(N, D, d),
    ...
    function U(e) {
      ...
      (t
        ? U(t)
        : n &&
          (null != n.__preactattr_ && s(n.__preactattr_.ref, null),
          (e.nextBase = n),
          f(n),
          m.push(e),
          v(n)),
...
***************************************************************************** */ var x =
        ...
        function Y(e, n) {
          return function () {
            ...
            return Q(arguments)
              ? ((t = r), o.apply(null, arguments))
              : ((t = Array.prototype.slice.call(arguments)), o);
          };
        }
        function Q(e) {
          return (
        ...
        var K,
          ...
          te = function (e, n, t) {
            ...
            return (
              (r.get = e),
              (r.set = "function" == typeof n ? n : r.set),
        ...
        function ie(e) {
          switch (e.dependenciesState) {
            ...
            case K.POSSIBLY_STALE:
              for (
                var n = De(!0), t = le(), r = e.observing, o = r.length, i = 0;
                i < o;
                i++
              ) {
                var M = r[i];
        ...
        function ae(e) {
          ...
          (Ye.computationDepth > 0 && n && M(!1),
            Ye.allowStateChanges ||
              (!n && "strict" !== Ye.enforceActions) ||
              M(!1));
        }
        function ue(e, n, t) {
          var r = De(!0);
          ...
          if (((Ye.trackingDerivation = e), !0 === Ye.disableErrorBoundaries))
            o = n.call(t);
          else
            try {
              o = n.call(t);
        ...
        function ye(e) {
          if (e.dependenciesState !== K.UP_TO_DATE) {
            ...
            for (var n = e.observing, t = n.length; t--; )
              n[t].lowestObserverState = K.UP_TO_DATE;
          }
        }
        var je = 0,
          ze = 1,
        ...
        function pe(e) {
          (je !== e.actionId &&
            M("invalid action stack. did you forget to finish an action?"),
            (je = e.parentActionId),
        ...
        var xe = (function (e) {
            function n(n, t, r, o, M) {
              (void 0 === r && (r = "ObservableValue@" + i()),
                void 0 === o && (o = !0),
                void 0 === M && (M = I.default));
            ...
            return (
              ...
              (n.prototype.prepareNewValue = function (e) {
                ...
                return (
                  ...
                  this.equals(this.value, e) ? Ye.UNCHANGED : e
                );
              }),
          ...
          he = (function () {
            ...
            return (
                          ...
                          ((e.lowestObserverState = K.STALE),
                            e.observers.forEach(function (n) {
                              n.dependenciesState === K.POSSIBLY_STALE
                                ? (n.dependenciesState = K.STALE)
                                : n.dependenciesState === K.UP_TO_DATE &&
                                  (e.lowestObserverState = K.UP_TO_DATE);
                            }));
                        })(this))
                    : ie(this) &&
              ...
              (e.prototype.computeValue = function (e) {
                var n;
                if (((this.isComputing = !0), Ye.computationDepth++, e))
                  n = ue(this, this.derivation, this.scope);
                else if (!0 === Ye.disableErrorBoundaries)
              ...
              (e.prototype.observe = function (e, n) {
                ...
                return sn(function () {
                  ...
                  if (!r || n) {
                    var M = le();
                    (e({ type: "update", object: t, newValue: i, oldValue: o }),
                      Ne(M));
                  }
                  ((r = !1), (o = i));
                });
        ...
        function Be(e, n) {
          (e.observers.add(n),
            e.lowestObserverState > n.dependenciesState &&
              (e.lowestObserverState = n.dependenciesState));
        }
        function Pe(e, n) {
        ...
        function Re(e) {
          !1 === e.isPendingUnobservation &&
            ((e.isPendingUnobservation = !0), Ye.pendingUnobservations.push(e));
        }
        function Ze() {
          Ye.inBatch++;
        }
          ...
          if (0 == --Ye.inBatch) {
            ...
            for (var e = Ye.pendingUnobservations, n = 0; n < e.length; n++) {
              ...
              ((t.isPendingUnobservation = !1),
                0 === t.observers.size &&
                  (t.isBeingObserved &&
                    ((t.isBeingObserved = !1), t.onBecomeUnobserved()),
                  t instanceof he && t.suspend()));
            }
          ...
          return !0 === r
            ...
            : t
              ? {
                  ...
                  get: function () {
                    return (
                      un(this, n, t.value || t.initializer.call(this)),
                      this[n]
                    );
                  },
                  set: nn,
        ...
        function jn(e) {
          ...
          if (
            (!0 === e.isolateGlobalState &&
              ((Ye.pendingReactions.length ||
                Ye.inBatch ||
                Ye.isRunningReactions) &&
                M(
                  "isolateGlobalState should be called before MobX is running any reactions",
                ),
              (Ue = !0),
              Se &&
                (0 == --Ce().__mobxInstanceCount &&
                  (Ce().__mobxGlobals = void 0),
                (Ye = new be()))),
            void 0 !== n)
          ) {
            var s = void 0;
            ...
            ((Ye.enforceActions = s),
              (Ye.allowStateChanges = !0 !== s && "strict" !== s));
          }
          (void 0 !== t && (Ye.computedRequiresReaction = !!t),
            void 0 !== a && (Ye.reactionRequiresObservable = !!a),
            void 0 !== u &&
              ((Ye.observableRequiresReaction = !!u),
              (Ye.allowStateReads = !Ye.observableRequiresReaction)),
        ...
        function Ln(e) {
          1 !== arguments.length &&
            M("Flow expects 1 argument and cannot be used as decorator");
              ...
              u = new Promise(function (e, r) {
                ...
                function c(n) {
                  if (!n || "function" != typeof n.then)
                    return n.done
                      ? e(n.value)
                      : (a = Promise.resolve(n.value)).then(u, s);
                  n.then(c, r);
                }
                ((t = r), u(void 0));
              });
        ...
        function Sn(e, n) {
          return (
            null != e &&
            (void 0 !== n
              ? !!mt(e) && e[d].values.has(n)
              : mt(e) || !!e[d] || E(e) || Ke(e) || ve(e))
          );
        }
        function Un(e) {
        ...
        function Gn(e, n) {
          if (Zn(e, n))
            return mt(e) ? e[n] : dt(e) ? e.get(n) : zt(e) ? e[n] : M(!1);
        }
        function Hn(e, n, t, r) {
          return "function" == typeof t
            ? (function (e, n, t, r) {
        ...
        function Jn(e, n) {
          ...
          return (
            ...
            n || (n = Wn),
            (n.detectCycles =
              void 0 === n.detectCycles
                ? !0 === n.recurseEverything
                : !0 === n.detectCycles),
            ...
            (function e(n, t, r) {
              ...
              if (
                (Un(n) && Qn(n),
                !0 === t.detectCycles && null !== n && r.has(n))
              )
                return r.get(n);
        ...
        function Kn(e, n, t) {
          return 1 === arguments.length || (n && "object" == typeof n)
            ? et(e, n)
            : $n(e, n, t || {});
        }
        function $n(e, n, t) {
        ...
        var Dt = (function () {
            ...
            return (
              ...
              (e.prototype.setArrayLength = function (e) {
                ...
                if (e !== n)
                  if (e > n) {
                    for (var t = new Array(e - n), r = 0; r < e - n; r++)
                      t[r] = void 0;
              ...
              (e.prototype.spliceItemsIntoValues = function (e, n, t) {
                var r;
                if (t.length < 1e4)
                  return (r = this.values).splice.apply(r, v([e, n], t));
                var o = this.values.slice(e, e + n);
                return (
                  (this.values = this.values
                    .slice(0, e)
                    .concat(t, this.values.slice(e + n))),
                  o
                );
              }),
          ...
          gt = {
            ...
            push: function () {
              ...
              var t = this[d];
              return (
                t.spliceWithArray(t.values.length, 0, e),
                t.values.length
              );
            },
            pop: function () {
            ...
            get: function (e) {
              ...
              if (n) {
                if (e < n.values.length)
                  return (n.atom.reportObserved(), n.dehanceValue(n.values[e]));
                console.warn(
            ...
            set: function (e, n) {
              ...
              if (e < r.length) {
                ...
                (n = t.enhancer(n, o)) !== o &&
                  ((r[e] = n), t.notifyArrayChildUpdate(e, n, o));
              } else {
                if (e !== r.length)
                  throw new Error(
          ...
          At = (function () {
            ...
            return (
              ...
              (e.prototype.set = function (e, n) {
                ...
                return (
                  t ? this._updateValue(e, n) : this._addValue(e, n),
                  this
                );
              }),
              (e.prototype.delete = function (e) {
                var n = this;
                if (
                  (ae(this._keysAtom), it(this)) &&
                  !(r = at(this, { type: "delete", object: this, name: e }))
                )
                  return !1;
                if (this._has(e)) {
                  var t = ut(this),
              ...
              (e.prototype._addValue = function (e, n) {
                ...
                (ae(this._keysAtom),
                  Xn(function () {
                    ...
                    (t._data.set(e, r),
                      (n = r.value),
                      t._updateHasMapEntry(e, !0),
                      t._keysAtom.reportChanged());
                  }));
                var r = ut(this),
                  o = r
                    ? { type: "add", object: this, name: e, newValue: n }
                    : null;
                r && ct(this, o);
              }),
            ...
            return (
              ...
              (e.prototype.clear = function () {
                ...
                Xn(function () {
                  ce(function () {
                    ...
                    try {
                      for (
                        var r = L(e._data.values()), o = r.next();
                        !o.done;
                        o = r.next()
                      ) {
                        var i = o.value;
              ...
              (e.prototype.add = function (e) {
                ...
                if (
                  ...
                  !(r = at(this, { type: "add", object: this, newValue: e }))
                )
                  return this;
                if (!this.has(e)) {
                  Xn(function () {
                    (n._data.add(n.enhancer(e, void 0)),
                      n._atom.reportChanged());
                  });
                  var t = ut(this),
              ...
              (e.prototype.delete = function (e) {
                ...
                if (
                  it(this) &&
                  !(r = at(this, { type: "delete", object: this, oldValue: e }))
                )
                  return !1;
                if (this.has(e)) {
                  var t = ut(this),
              ...
              (e.prototype.values = function () {
                ...
                return _t({
                  next: function () {
                    return n < t.length
                      ? { value: e.dehanceValue(t[n++]), done: !1 }
                      : { done: !0 };
                  },
                });
              }),
        ...
        function Ot(e, n, t) {
          if (
            ...
            return e[d];
          (l(e) || (n = (e.constructor.name || "ObservableObject") + "@" + i()),
            n || (n = "ObservableObject@" + i()));
        ...
        function bt(e, n) {
          if ("object" == typeof e && null !== e) {
            ...
            if (dt(e)) {
              ...
              return void 0 === n
                ? t._keysAtom
                : ((r = t._data.get(n) || t._hasMap.get(n)) || M(!1), r);
            }
            var r;
            if ((U(e), n && !e[d] && e[n], mt(e)))
              return n ? ((r = e[d].values.get(n)) || M(!1), r) : M(!1);
        ...
        function kt(e, n) {
          return (
            ...
            void 0 !== n
              ? kt(bt(e, n))
              : E(e) || ve(e) || Ke(e) || dt(e) || wt(e)
                ? e
                : (U(e), e[d] ? e[d] : void M(!1))
          );
        }
        function Ct(e, n) {
          return (
            void 0 !== n ? bt(e, n) : mt(e) || dt(e) || wt(e) ? kt(e) : bt(e)
          ).name;
        }
        ...
        function Ut(e, n, t) {
          return (
            ...
            (function e(n, t, r, o, i) {
              ...
              if (n != n) return t != t;
              var M = typeof n;
              if ("function" !== M && "object" !== M && "object" != typeof t)
                return !1;
              var a = St.call(n);
              ...
              switch (a) {
                ...
                case "[object Symbol]":
                  return (
                    "undefined" != typeof Symbol &&
                    Symbol.valueOf.call(n) === Symbol.valueOf.call(t)
                  );
                case "[object Map]":
                case "[object Set]":
                  r >= 0 && r++;
              ...
              if ((o.push(n), i.push(t), u)) {
                ...
                for (; l--; )
                  if (((D = N[l]), !Qt(t, D) || !e(n[D], t[D], r - 1, o, i)))
                    return !1;
              }
                ...
                return (
                  ((u = new o.Reaction(n + ".render()", function () {
                    if (
                      ...
                      try {
                        ((i = !0),
                          t || r.Component.prototype.forceUpdate.call(e),
                          (n = !1));
                      } finally {
                        ((i = !1), n && u.dispose());
                      }
                        ...
                        value: function () {
                          ...
                          for (var o in this.props)
                            this.props.hasOwnProperty(o) &&
                              (t[o] = this.props[o]);
                          var i =
                            e(this.context.mobxStores || {}, t, this.context) ||
                            {};
  ...
  function (e, n, t) {
    ...
    var s = (n.HTTPError = (function (e) {
        function n(e) {
          ...
          var t = a(
            this,
            (n.__proto__ || Object.getPrototypeOf(n)).call(this, e.statusText),
          );
          return (
            (t.name = t.constructor.name),
            "function" == typeof Error.captureStackTrace
              ? Error.captureStackTrace(t, t.constructor)
              : (t.stack = new Error(e.statusText).stack),
            (t.status = e.status),
            t
          );
        }
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  ...
                  fetch(this.apiURL + e, r({}, t, { headers: o })).then(
                    function (e) {
        ...
        (t = [
          {
            ...
            value: function () {
              ...
              return (0, o.h)(
                "button",
                { type: "submit", className: "btn".concat(n ? " saving" : "") },
                n ? r || "Saving" : t || "Save",
              );
            },
          },
  ...
  function (e, n, t) {
    ...
    (void 0 !== i(n) && (n.netlifyIdentity = o.default),
      void 0 !== ("undefined" == typeof window ? "undefined" : i(window)) &&
  ...
  function (e, n, t) {
            ...
            (Array.prototype.slice.call(N).forEach(function (e) {
              ...
              (0, r.render)(
                (0, r.h)(
                  i.Provider,
                  { store: u.default },
                  (0, r.h)(s.default, { mode: n, text: e.innerText.trim() }),
                ),
                e,
                null,
              );
              ...
              ((w = document.createElement("iframe")).id =
    ...
    function m() {
      ...
      if (e) {
        ...
        if (
          (n &&
            (u.default.verifyToken(n[1], n[2]), (document.location.hash = "")),
          e.match(h) &&
          ...
          if (
            ...
            document &&
              t.access_token &&
              (document.cookie = "nf_jwt=".concat(t.access_token)),
            t.state)
          )
            try {
          ...
          ((document.location.hash = ""),
            ...
            u.default.completeExternalLogin(t));
        }
      }
    }
    var b = A;
  ...
  function (e, n, t) {
    ...
    n.getPagination = function (e) {
      ...
      n = n.split(",");
      for (
        var o = e.headers.get("X-Total-Count"), i = 0, M = n.length;
        i < M;
        i++
      ) {
                ...
                if (t)
                  try {
                    var r = JSON.parse(t),
                      ...
                      a = r.audience;
                    return o && M
                      ? new e(n || new i.default(o, {}), M, a)._saveUserData(
                          r,
                          !0,
                        )
                      : null;
          ...
          (t = [
                ...
                return N[e]
                  ...
                  : (N[e] = this.api
                      ...
                      .then(function (t) {
                        return (
                          delete N[e],
                          n._processTokenResponse(t),
                          n._refreshSavedSession(),
            ...
            },
            {
              ...
              get: function () {
                var n = {};
                for (var t in this)
                  t in e.prototype || t in y || (n[t] = this[t]);
                return n;
              },
            },
          ]) && l(n.prototype, t),
          ...
          (o = (function (e) {
            ...
            function M() {
              ...
              for (
                ...
                t[r] = arguments[r];
              return (
                ((e = o.call.apply(o, [this].concat(t))).handleClose =
                  function () {
          ...
          (n.addSiteURL = function (e) {
            ...
            var t,
              ...
              o =
                ((t = n.state.url),
                (r = "/.netlify/identity"),
                -1 === t.indexOf(r) ? t : t.substring(0, t.length - r.length));
            n.props.onSiteURL(o);
          }),
  ...
  function (e, n, t) {
    ...
    var D = (function (e) {
        ...
        function t() {
          var e;
          i(this, t);
          for (var r = arguments.length, o = new Array(r), M = 0; M < r; M++)
            o[M] = arguments[M];
          return (
            ((e = n.call.apply(n, [this].concat(o))).handleLogin = function (
              n,
            ) {
              (n.preventDefault(),
  ...
  function (e, n, t) {
    ...
    ((i.setNamePlaceholder = (0, r.action)(function (e) {
      ...
      (i.init = (0, r.action)(function (e, n) {
        (e &&
          ((i.gotrue = e),
          (i.user = e.currentUser()),
          i.user && (i.modal.page = "user")),
          n && i.loadSettings());
      })),
          ...
          (i.gotrue &&
            i.gotrue
              ...
              .catch(
                (0, r.action)(function (e) {
                  i.error = new Error(
                    "Failed to load settings from ".concat(i.gotrue.api.apiURL),
                  );
                }),
              ));
      })),
            ...
            .then(
              (0, r.action)(function (e) {
                ((i.user = e),
                  (i.modal.page = "user"),
                  (i.invite_token = null),
                  i.email_change_token && i.doEmailChange(),
                  (i.saving = !1));
              }),
            )
            .catch(i.setError)
      ...
      (i.externalLogin = (0, r.action)(function (e) {
        ...
        var n = i.invite_token
          ? i.gotrue.acceptInviteExternalUrl(e, i.invite_token)
          : i.gotrue.loginExternalUrl(e);
      ...
      (i.signup = (0, r.action)(function (e, n, t) {
        return (
          ...
          i.gotrue
            ...
            .then(
              (0, r.action)(function () {
                (i.settings.autoconfirm
                  ? i.login(n, t, i.remember)
                  : (i.message = "confirm"),
                  (i.saving = !1));
              }),
            )
        ...
        return (
          ...
          i.user
            ...
            .then(
              (0, r.action)(function (e) {
                ((i.user = e),
                  (i.email_change_token = null),
                  (i.message = "email_changed"),
                  (i.saving = !1));
              }),
            )
            .catch(i.setError)
      ...
      (i.verifyToken = (0, r.action)(function (e, n) {
        ...
        switch (((i.modal.isOpen = !0), e)) {
          case "confirmation":
            ...
            break;
          case "email_change":
            ((i.email_change_token = n),
              (i.modal.page = "message"),
              i.user ? i.doEmailChange() : (i.modal.page = "login"));
            break;
          case "invite":
        ...
        (o = (function (e) {
          ...
          function c() {
            ...
            for (var n = arguments.length, t = new Array(n), r = 0; r < n; r++)
              t[r] = arguments[r];
            return (
              ((e = o.call.apply(o, [this].concat(t))).handleSignup = function (
                n,
              ) {
